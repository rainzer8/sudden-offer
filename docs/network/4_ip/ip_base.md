...
那么，说来就来！而且要盘就盘全一点，顺便挑战下晓峰的图解功力，所以就来个 **IP 基础知识全家桶**。
...
举个生活的栗子，晓峰要去一个很远的地方旅行，制定了一个行程表，其间需先后乘坐飞机、地铁、公交车才能抵达目的地，为此晓峰需要买飞机票，地铁票等。
...
如果晓峰只有行程表而没有车票，就无法搭乘交通工具到达目的地。相反，如果除了车票而没有行程表，恐怕也很难到达目的地。因为晓峰不知道该坐什么车，也不知道该在哪里换乘。
...
其中对于 A、B、C 类主要分为两个部分，分别是**网络号和主机号**。这很好理解，好比晓峰是 A 小区 1 栋 101 号，你是 B 小区 1 栋 101 号。
