...
那么，说来就来！而且要盘就盘全一点，顺便挑战下小速的图解功力，所以就来个 **IP 基础知识全家桶**。
...
举个生活的栗子，小速要去一个很远的地方旅行，制定了一个行程表，其间需先后乘坐飞机、地铁、公交车才能抵达目的地，为此小速需要买飞机票，地铁票等。
...
如果小速只有行程表而没有车票，就无法搭乘交通工具到达目的地。相反，如果除了车票而没有行程表，恐怕也很难到达目的地。因为小速不知道该坐什么车，也不知道该在哪里换乘。
...
其中对于 A、B、C 类主要分为两个部分，分别是**网络号和主机号**。这很好理解，好比小速是 A 小区 1 栋 101 号，你是 B 小区 1 栋 101 号。
