...
计网的话我是看小速的图解网络 + b 站的湖科大的老师做的视频，都附带了很多图和动画，简单易懂。参考的文字材料就是自顶向下 + TCP/IP 详解卷 1。

OS 没有找过网课看，觉得看完 CSAPP 之后挺好理解的了。用的文字材料主要是小速的图解系统 + 操作系统概论。
...
首先对照着一些简单易懂的公开课/小速的图解系列等了解知识雏形，然后再自己从专业书里更详细的学习。
