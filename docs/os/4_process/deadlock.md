...
举个例子，晓峰拿了小美房间的钥匙，而晓峰在自己的房间里，小美拿了晓峰房间的钥匙，而小美也在自己的房间里。如果晓峰要从自己的房间里出去，必须拿到小美手中的钥匙，但是小美要出去，又必须拿到晓峰手中的钥匙，这就形成了死锁。
...
由于晓峰的死锁代码例子是 C 写的，在 Linux 下，我们可以使用 `pstack` + `gdb` 工具来定位死锁问题。
